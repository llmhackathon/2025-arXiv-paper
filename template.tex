...
\noptcrule
\mtcsetfont{parttoc}{section}{\fontsize{7.5pt}{7.5pt}\sffamily}
...
%--------------------------------------------------
% CUSTOM ENVIRONMENT FOR TEAM SUBMISSIONS
%--------------------------------------------------
% Counter for team submissions (since they're added manually)
\newcounter{teamcount}
...
%--------------------------------------------------
% COMMANDS FOR AUTHORS AND AFFILIATIONS
%--------------------------------------------------
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{teamsubmission}{Submission Template}{Your Paper Title}
\authorsblock{
    Author1\textsuperscript{1},
    Author2\textsuperscript{2},
    Author3\textsuperscript{3}
}
\affiliationsblock{
...
\section*{Summary Guideline}
Please ensure your paper includes:
\begin{itemize}
    \item \textbf{Introduction:} Brief background (2–3 lines)
    \item \textbf{Results:} Results, workflow, and at least one figure/table
    \item \textbf{Future Work:} 1–2 sentences on next steps
    \item \textbf{Open-source Materials:} GitHub/demo links
    \item \textbf{Author Contributions:} CRediT taxonomy roles
    \item \textbf{References:} 4–6 key references. Here are some references~\cite{chemQA2024,openai2024gpt4technicalreport}
\end{itemize}
Do not use bullet points in your final submission—write in prose. 
\end{teamsubmission}
...
\begin{teamsubmission}{Alpha Squad}{Predicting Catalyst Stability Using Graph Neural Networks}
\authorsblock{
    Jane Doe\textsuperscript{1}\orcidlink{0000-0001-2345-6789},
    John Smith\textsuperscript{2}\orcidlink{0000-0002-3456-7890},
    Liu Wei\textsuperscript{3}\orcidlink{0000-0003-4567-8901}
}
\affiliationsblock{
    \textsuperscript{1}Department of Chemical Process \& Energy Engineering, Example University, London, UK\\
    \textsuperscript{2}Department of Mechanical Engineering, Example Institute, Chicago, USA\\
    \textsuperscript{3}Department of Mechanical Engineering, Sample Tech, London, UK
}

\section*{Introduction}
The Catalyst degradation is a key bottleneck in industrial reactions. We use graph neural networks (GNNs)~\cite{zhou2021graphneuralnetworksreview} to predict catalyst stability.

\section*{Results}
Our workflow integrates Materials Project~\cite{Jain2013} data with DFT-derived stability labels. The GNN achieved a mean absolute error of 0.12 eV. Figure~\ref{fig:demo-pipeline} shows the architecture.
Add more description to your entry...
\begin{figure}[h]
    \centering
\includegraphics[width=0.65\linewidth]{figures/pipeline.png}
    \caption{Workflow of our model pipeline.}
    \label{fig:demo-pipeline}
\end{figure}

\section*{Future Work}
We plan to extend datasets to transition-metal oxides.

\section*{Open-source Materials}
Code and pretrained weights available on GitHub: \github{https://github.com/example/catalyst-gnn}

\section*{Author Contributions}
J.D.: Conceptualization; J.S.: Data Curation; L.W.: Visualization.
\end{teamsubmission}

% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ==> Add Your Team below by copying the template above   %
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\authorsblock{
L. Genovese\textsuperscript{1}\orcidlink{0000-0003-1747-0247}, 
G. Fisicaro\textsuperscript{2}\orcidlink{0000-0003-4502-3882}, 
L. Beal\textsuperscript{3}\orcidlink{0009-0000-6474-2722}, 
É. Polack\textsuperscript{1}\orcidlink{0000-0003-0543-2008}, 
Y. Curè\textsuperscript{1}, %, 
D. Caliste\textsuperscript{1}\orcidlink{0000-0002-4967-9275}, 
W. Dawson\textsuperscript{4}\orcidlink{0000-0003-4480-8565}, 
J. Janssen\textsuperscript{5}\orcidlink{0000-0001-9948-7119}, 
C. Herrera Contreras\textsuperscript{1}\orcidlink{0000-0001-6405-0785}, 
Y. Briki\textsuperscript{6}\orcidlink{0009-0006-1083-5986}, 
L. Didukh\textsuperscript{7}\orcidlink{0000-0003-4900-5227}%,
...
\begin{teamsubmission}{Team AgentLearn}{AgentLearn: Accelerating Active Learning with LLM agents}
\authorsblock{
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Team: KG_Ontology Team %
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%%%%%%%%%%%%%%% this draft is under writing and editing
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CLUE: Crystal Learning for Understandable Explanations  %
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% \begin{figure}
%     \centering
%     \includegraphics[width=1\linewidth]{figures/maze.jpg}
